...
Gui, Add, Radio, x366 y15 w40 h30 , Y
Gui, Add, Radio, x416 y15 w40 h30 , N

Gui, Add, Text, x16 y65 w340 h30 , Is the BMI >= 40`, or >=35 with comorbidities?   (increased post-op risk)
Gui, Add, Radio, x366 y55 w40 h30 , Y
Gui, Add, Radio, x416 y55 w40 h30 , N

Gui, Add, Text, x16 y102 w340 h30 , Is the A1c >= 7.5`%  (increased post-op risk)
Gui, Add, Radio, x366 y95 w40 h30 , Y
Gui, Add, Radio, x416 y95 w40 h30 , N
...
Gui, Add, Text, x16 y182 w340 h100 , Is the patient on anticoagulation for a medical indication?`n`n  a. Warfarin / coumadin with plan for bridging`n`n  b. Xarelto / Eliquis`, or`n`n  c. Aspirin / Plavix
...
Gui, Add, Button, x326 y570 w120 h30 , Calc Score
